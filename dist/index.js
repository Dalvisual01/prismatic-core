import { createContext, forwardRef, useRef, useCallback, useEffect, useImperativeHandle, useContext, useState, useMemo, useLayoutEffect, Children, useId } from 'react';
...
function LayoutModeChrome() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "pointer-events-none fixed bottom-4 left-1/2 z-50 -translate-x-1/2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-full border border-white/15 bg-[var(--prismatic-overlay-bg)] px-4 py-2 text-[11px] lowercase tracking-wide text-white/85 shadow-lg backdrop-blur-md", children: [
    /* @__PURE__ */ jsx("span", { className: "text-white", children: "layout mode" }),
    /* @__PURE__ */ jsx("span", { className: "text-white/35", children: "\xB7" }),
    /* @__PURE__ */ jsx("span", { className: "text-white/55", children: "press w to toggle workspace" }),
    /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
    ...
    status === "saved" ? /* @__PURE__ */ jsx("span", { className: "text-white/65", children: "saved" }) : null,
    status === "error" ? /* @__PURE__ */ jsx("span", { className: "text-[var(--prismatic-accent)]", children: error ?? "save failed" }) : null
  ] }) });
}
...
function PrismaticProvider({
  ...
  return /* @__PURE__ */ jsx(PrismaticStoreContext.Provider, { value: store, children: /* @__PURE__ */ jsxs("div", { className: "prismatic-root contents", style: themeStyle, children: [
    children,
    layoutMode ? /* @__PURE__ */ jsx(LayoutModeChrome, {}) : null
  ] }) });
}
...
var CreativeCanvas = forwardRef(
  function CreativeCanvas2({ createSketch }, ref) {
    ...
    const applyFrameAsSource = useCallback(async () => {
      const p = pInstRef.current;
      if (!p) return null;
...
function AppTitle({
  ...
  const resolvedLogo = logo ?? (logoSrc ? /* @__PURE__ */ jsx(
    "img",
    {
      src: logoSrc,
      alt: logoAlt,
...
function AppTitlePanel({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { ref: rootRef, className: "workspace-panel relative w-fit", children: [
        /* @__PURE__ */ jsx(AppTitle, { ...titleProps, size: currentSize }),
        ...
        workspaceMode && resizing && /* @__PURE__ */ jsx("div", { className: "workspace-controls prismatic-bg-overlay prismatic-text-primary pointer-events-none absolute bottom-1 left-1/2 z-30 -translate-x-1/2 rounded-full px-2 py-0.5 text-[10px] lowercase backdrop-blur-sm", children: currentSize === "small" ? "S" : "M" })
      ] })
    }
  );
}
var ImagePanelSizeContext = createContext(null);
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          style: panelSize,
          children: [
            /* @__PURE__ */ jsx(ImagePanelSizeContext.Provider, { value: panelSize.width, children: /* @__PURE__ */ jsx("div", { className: "flex size-full items-center justify-center", children }) }),
            showControls && /* @__PURE__ */ jsx("div", { className: "workspace-controls pointer-events-auto absolute left-1 top-1 z-30", children: /* @__PURE__ */ jsx(ImageSizeToolbar, { modules: imageModules, onChange: setImageModules }) }),
            workspaceMode && /* @__PURE__ */ jsx(
              "div",
              {
                className: [
...
function ButtonPanel({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      onMouseLeave: scheduleCloseControls,
      children: /* @__PURE__ */ jsxs("div", { ref: rootRef, className: "workspace-panel relative w-fit", children: [
        /* @__PURE__ */ jsx(Button, { ...buttonProps, size: currentSize, children }),
        showControls && /* @__PURE__ */ jsx("div", { className: "workspace-controls pointer-events-auto absolute left-1 top-1 z-30", children: /* @__PURE__ */ jsx(
          ButtonSizeToolbar,
          {
            size: currentSize,
        ...
        workspaceMode && resizing && /* @__PURE__ */ jsx("div", { className: "workspace-controls prismatic-bg-overlay prismatic-text-primary pointer-events-none absolute bottom-1 left-1/2 z-30 -translate-x-1/2 rounded-full px-2 py-0.5 text-[10px] lowercase backdrop-blur-sm", children: SIZE_LABELS[currentSize] })
      ] })
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute left-1/2 bottom-[-7px] h-0 w-0 -translate-x-1/2 border-l-[7px] border-r-[7px] border-t-[7px] border-l-transparent border-r-transparent border-t-[#242326]" })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            "aria-hidden": true,
            children: CANVAS_RESOLUTION_SCALES.map((candidate) => /* @__PURE__ */ jsx(
              "div",
              {
                className: [
                ...
                children: /* @__PURE__ */ jsx("span", { className: "block text-[rgba(255,255,255,0.9)]", children: SCALE_LABEL[candidate] })
              },
              candidate
            ))
          }
